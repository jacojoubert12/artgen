...
class BadgesCenterView extends StatefulWidget {
  const BadgesCenterView({Key key, this.setViewMode,}) : super(key: key);
...
//   }) : super(key: key);
  ...
  @override
  _BadgesCenterViewState createState() => _BadgesCenterViewState();
}

class _BadgesCenterViewState extends State<BadgesCenterView> {
